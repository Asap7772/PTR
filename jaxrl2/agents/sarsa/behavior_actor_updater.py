...
def update_behavior_actor(key: PRNGKey, actor: TrainState, critic: TrainState,
                 temp: TrainState,
    ...
    def actor_loss_fn(
        ...
        actor_loss = (log_pis * temp.apply_fn({'params': temp.params}) - log_probs).mean()

        q = critic.apply_fn({'params': critic.params}, batch['observations'], actions)
